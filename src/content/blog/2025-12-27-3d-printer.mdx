...
<img
  ...
  style={{ width: "100%" }}
/>
I've always got a pile of random bits and bobs on my desk, so I printed this under-desk drawer to try help keep things tidy. It fits perfectly under my desk and holds things like a portable ssd, and some stationery.
...
_By: [motherfucker](https://cults3d.com/en/3d-model/various/side-load-bottle-cage-for-375-ml-can)_
...
A word of warning this one is additive, before you know it you'll be measuring up all your drawers and printing custom inserts for everything you own. [Gridfinity](https://gridfinity.xyz/) is a modular storage system that uses a grid of interlocking bases and containers. Really useful for taking that junk drawer of batteries, screws, and that the random allen key you got from an Ikea flat-pack and brining some order to it.


 There's a bunch of online generators like [gridfinitygenerator](https://gridfinitygenerator.com/en) so you can create the exact grid and containers for your draw. And there's hundreds of premade inserts on printables and makerworld. There's also [tooltrace](https://www.tooltrace.ai/) which takes a photo of the object you want to store and generates a custom insert for it.
...
_By: [Abstractia Design](https://makerworld.com/en/models/1078586-dual-vertical-laptop-stand-closed-macbook-stand?from=search#profileId-1069906)_
